...
export const getDashboardStats = catchAsyncError(async (req, res, next) => {
  ...
  if (statsData[10].subscription === 0)
    subscriptionPercentage = subscriptionCount * 100;
      ...
      const difference = {
        users: statsData[10].users - statsData[10].users,
        views: statsData[10].views - statsData[10].views,
        subscription: statsData[10].subscription - statsData[10].subscription
      }
